-- CreateEnum
CREATE TYPE "InstanceStatus" AS ENUM ('PENDING', 'RUNNING', 'STOPPED', 'DELETING', 'ERROR');
...
-- AddForeignKey
ALTER TABLE "WpInstance" ADD CONSTRAINT "WpInstance_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
